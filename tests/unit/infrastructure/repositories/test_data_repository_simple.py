...
class TestJsonRepositorySimple(unittest.TestCase):
    """Testes simplificados para JsonRepository"""
...
class TestExcelRepositorySimple(unittest.TestCase):
    """Testes simplificados para ExcelRepository"""
