...
def create_simple_db(auto_mode=False):
    ...
    try:
        ...
        sqls = [
            ...
            "CREATE TABLE TB_BAIRROS (ID_BAIRRO COUNTER PRIMARY KEY, NOME_BAIRRO TEXT(100), UF TEXT(2), ID_MUNICIPIO LONG, ATIVO BIT, DATA_CRIACAO DATE)",
            ...
            "CREATE TABLE TB_CEP_CONFIG (ID_CEP_CONFIG COUNTER PRIMARY KEY, CEP TEXT(10), CIDADE TEXT(100), ESTADO TEXT(2), LOGRADOURO TEXT(255), RAIO_KM INTEGER, DATA_ATUALIZACAO DATE)",
