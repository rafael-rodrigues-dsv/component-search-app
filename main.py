...
def _create_cache_automatically() -> bool:
    """Cria o banco de cache SQLite automaticamente (garante que todas as tabelas existam)"""
    try:
        cache_path = Path("data/cache/pythonsearchcache.db")
...
def main():
    ...
    print(f"[INFO] Iniciando Python Search App - v{__version__}")
